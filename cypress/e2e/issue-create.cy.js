...
describe("Issue create", () => {
  ...
  it("Should create an issue and validate it successfully", () => {
    ...
    cy.get('[data-testid="modal:issue-create"]').within(() => {
      ...
      // Select Pickle Rick from reporter dropdown - Correctly, assignee dropdown, otherwise avator is not shown later.
  ...
  it("Should create Test Case 1 issue and validate it successfully", () => {
    cy.get('[data-testid="modal:issue-create"]').within(() => {
  ...
  it("Should create Test Case 2 issue and validate it successfully", () => {
    cy.get('[data-testid="modal:issue-create"]').within(() => {
      ...
      cy.get('[data-testid="select:type"]').click();
      cy.get('[data-testid="select-option:Story"]').click(); // Reset selection of Task once
      cy.get('[data-testid="select:type"]').click();
